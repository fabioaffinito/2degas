...
#
F90_SRC =  mpif_mod.f90 mpif.f90 utils.f90 oldblas.f90 tools.f90 ewald.f90 stats.f90 \
           input.f90 main.f90 two_body.f90 \
           stubs.f90 reptation.f90 three_body.f90  algorithms.f90 dump.f90   
OBJS =  mpif_mod.o mpif.o utils.o oldblas.o  ewald.o stats.o\
        input.o main.o  two_body.o \
